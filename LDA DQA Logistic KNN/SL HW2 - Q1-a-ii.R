...
#RobustClassBal <- tibble::rownames_to_column(RobustClassBal, "Variables")
...
#RelativeImportResult <- tibble::rownames_to_column(RelativeImportResult, "Variables")
...
mashAccuracy <- AccuracyGraph + labs(title = "Accuracy from 3 Models", x = "Model") + scale_fill_gradient(low="skyblue2",high="tomato")
# Precision
...
mashPrecision <- PrecisionGraph + labs(title = "Precision from 3 Models", x = "Model") + scale_fill_gradient(low="seagreen4",high="darkorange")
# Recall
...
mashRecall <- RecallGraph + labs(title = "Recall from 3 Models", x = "Model") + scale_fill_gradient(low="dimgray",high="darkgoldenrod1")
